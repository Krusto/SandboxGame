...
inline static const std::array<VoxelVertex, 4> TopBlockFaceVertices = {
...
inline static const std::array<VoxelVertex, 4> BottomBlockFaceVertices = {
...
inline static const std::array<VoxelVertex, 4> LeftBlockFaceVertices = {
...
inline static const std::array<VoxelVertex, 4> RightBlockFaceVertices = {
...
inline static const std::array<VoxelVertex, 4> FrontBlockFaceVertices = {
...
inline static const std::array<VoxelVertex, 4> BackBlockFaceVertices = {
...
inline static const std::array<VoxelVertex, 4> BlockFaceVertices[6] = {LeftBlockFaceVertices,  RightBlockFaceVertices,
                                                                       TopBlockFaceVertices,   BottomBlockFaceVertices,
                                                                       FrontBlockFaceVertices, BackBlockFaceVertices};