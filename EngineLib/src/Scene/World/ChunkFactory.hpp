...
namespace Engine
{
    ...
    public:
        ...
        static std::size_t GeneratedChunksCount();
    ...
    private:
        ...
        inline static std::size_t s_CurrentChunkGenerationCount = 0;
        inline static constexpr std::size_t s_MaxChunksToGenerate = 200;
    };
}// namespace Engine
