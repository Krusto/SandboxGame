...
EXPORT_RENDERER void* CubemapTextureGetSpec(void* data);
EXPORT_RENDERER int CubemapTextureGetID(void* data);
...
EXPORT_RENDERER void ShaderSetUniform4I(void* data, const char* fullname, int32_t x, int32_t y, int32_t z, int32_t w);
...
EXPORT_RENDERER void StorageBufferInit(void** data, void* vertexArray, char* storageData, unsigned int size, int type);
